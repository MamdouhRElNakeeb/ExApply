package ml.exapply.app.fragment;
...
import ml.exapply.app.activity.ExperienceDetails;
import ml.exapply.app.adapter.FeedRVAdapter;
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (category.equals("All")){
                    for (String categ: getResources().getStringArray(R.array.categories_array)){

                        for (DataSnapshot postSnapshot: dataSnapshot.child(categ).getChildren()) {
                            ExperienceData experienceData = postSnapshot.getValue(ExperienceData.class);
