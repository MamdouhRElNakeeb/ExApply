...
import com.exapply.mobapp.Objects.MaterialCalendar;
import com.exapply.mobapp.R;
import com.exapply.mobapp.fragment.ScheduleFragment;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mHolder.mSelectedDayImageView != null) {
            ...
            if (gridView.isItemChecked(position)) {
                ...
                mHolder.mTextView.setTextColor(ContextCompat.getColor(mContext, R.color.white));
                mHolder.mSavedEventImageView.setColorFilter(ContextCompat.getColor(mContext, R.color.white));
                ...
                mHolder.mSavedEventImageView.setColorFilter(ContextCompat.getColor(mContext, R.color.theme_primary_dark));
            }
        }
